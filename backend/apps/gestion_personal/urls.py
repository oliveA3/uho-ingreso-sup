...
from .views import StudentDashboardView, StudentExamConfirmationView, StudentInterestEditView, StudentInterestItemView, StudentInterestSendView, StudentInterestView, StudentOtorgamientoView, StudentProfileView, StudentSolicitudEditView, StudentSolicitudPdfView, StudentSolicitudView


urlpatterns = [
    path("estudiante/dashboard/", StudentDashboardView.as_view(), name="student-dashboard"),
    path("estudiante/perfil/", StudentProfileView.as_view(), name="student-profile"),
    ...
    path("estudiante/otorgamiento/", StudentOtorgamientoView.as_view(), name="student-otorgamiento"),
]