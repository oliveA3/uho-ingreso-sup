    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div>
            ...
            <p className="mt-2 text-xs text-slate-600">Consulta tus notas, tu posición en el escalafón y el estado de validación en el proceso de ingreso.</p>
        </div>
        ...
        {current && <div className="mt-6 space-y-4">
          ...
          {(current.estado === "por_revisar" || current.estado === "sin_respuesta") && <div className="rounded-2xl border border-slate-200 p-4">
