export default function HeroSection() {
  return (
    <section className="mb-12 rounded-[2rem] bg-gradient-to-r from-sky-700 via-cyan-600 to-teal-500 px-6 py-12 text-white shadow-lg sm:px-10">
      <div className="mx-auto max-w-5xl">
        <p className="text-sm uppercase tracking-[0.3em] text-cyan-100">Proceso de Ingreso 2025</p>
        <h1 className="mt-4 text-4xl font-black tracking-tight sm:text-5xl">IngresoSUP — Información oficial del proceso de solicitud y otorgamiento.</h1>
        <p className="mt-4 max-w-3xl text-base leading-8 text-cyan-100 sm:text-lg">
